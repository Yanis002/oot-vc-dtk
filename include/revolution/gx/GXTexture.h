...
void GXInitTexObj(GXTexObj *, void *image, u16 width, s32 height, s32 texFormat, s32 wrapModeS, s32 wrapModeT, bool mipmap);
void GXInitTexObjCI(GXTexObj *, void *, s32 width, s32 height, s32 texFormat, s32 wrapModeS, s32 wrapModeT, bool mipmap, s32 tlut);
void GXInitTexObjLOD(GXTexObj *, int min_filt, int mag_filt, s32 biasClampEnable, s32 edgeLodEnable, s32 anisotropy, f32 minLod, f32 maxLod, f32 lodBias);
