...
static struct MEMiHeapHead* MEMCreateFrmHeap(void* start, u32 size) { return MEMCreateFrmHeapEx(start, size, 0); }

static void* MEMAllocFromFrmHeap(struct MEMiHeapHead* heap, u32 size) { return MEMAllocFromFrmHeapEx(heap, size, 4); }
