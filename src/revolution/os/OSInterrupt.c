...
OSInterruptHandler __OSGetInterruptHandler(OSInterruptType type) { return InterruptHandlerTable[type]; }
...
void __OSInterruptInit(void) {
    ...
    *(u32*)OSPhysicalToCached(OS_PHYS_CURRENT_INTR_MASK) = 0;
    ...
    __OSMaskInterrupts(OS_INTR_MASK(OS_INTR_MEM_0) | OS_INTR_MASK(OS_INTR_MEM_1) | OS_INTR_MASK(OS_INTR_MEM_2) |
                       OS_INTR_MASK(OS_INTR_MEM_3) | OS_INTR_MASK(OS_INTR_MEM_ADDRESS) | OS_INTR_MASK(OS_INTR_DSP_AI) |
                       OS_INTR_MASK(OS_INTR_DSP_ARAM) | OS_INTR_MASK(OS_INTR_DSP_DSP) | OS_INTR_MASK(OS_INTR_AI_AI) |
                       ...
                       OS_INTR_MASK(OS_INTR_EXI_2_EXI) | OS_INTR_MASK(OS_INTR_EXI_2_TC) | OS_INTR_MASK(OS_INTR_PI_CP) |
                       OS_INTR_MASK(OS_INTR_PI_PE_TOKEN) | OS_INTR_MASK(OS_INTR_PI_PE_FINISH) |
                       OS_INTR_MASK(OS_INTR_PI_SI) | OS_INTR_MASK(OS_INTR_PI_DI) | OS_INTR_MASK(OS_INTR_PI_RSW) |
                       OS_INTR_MASK(OS_INTR_PI_ERROR) | OS_INTR_MASK(OS_INTR_PI_VI) | OS_INTR_MASK(OS_INTR_PI_DEBUG) |
...
static u32 SetInterruptMask(u32 type, u32 mask) {
    ...
    switch (__cntlzw(type)) {
        ...
        case OS_INTR_MEM_ADDRESS:
            ...
            return type & ~(OS_INTR_MASK(OS_INTR_MEM_0) | OS_INTR_MASK(OS_INTR_MEM_1) | OS_INTR_MASK(OS_INTR_MEM_2) |
                            OS_INTR_MASK(OS_INTR_MEM_3) | OS_INTR_MASK(OS_INTR_MEM_ADDRESS));
        /**
         * DSP interrupts
         */
        case OS_INTR_DSP_AI:
        ...
        case OS_INTR_DSP_DSP:
            ...
            dspMask &= ~(DSP_CSR_AIDINT | DSP_CSR_AIDINTMSK | DSP_CSR_ARINT | DSP_CSR_ARINTMSK | DSP_CSR_DSPINT |
                         DSP_CSR_DSPINTMSK);
            ...
            return type &
                   ~(OS_INTR_MASK(OS_INTR_DSP_AI) | OS_INTR_MASK(OS_INTR_DSP_ARAM) | OS_INTR_MASK(OS_INTR_DSP_DSP));
        /**
         * AI interrupts
         */
        case OS_INTR_AI_AI:
        ...
        case OS_INTR_EXI_0_EXT:
            ...
            exi0Mask &= ~(EXI_CPR_EXIINTMASK | EXI_CPR_EXIINT | EXI_CPR_TCINTMASK | EXI_CPR_TCINT | EXI_CPR_EXTINTMASK |
                          EXI_CPR_EXTINT | EXI_CPR_ROMDIS);
            ...
            return type & ~(OS_INTR_MASK(OS_INTR_EXI_0_EXI) | OS_INTR_MASK(OS_INTR_EXI_0_TC) |
        ...
        case OS_INTR_EXI_1_EXT:
            ...
            exi1Mask &= ~(EXI_CPR_EXIINTMASK | EXI_CPR_EXIINT | EXI_CPR_TCINTMASK | EXI_CPR_TCINT | EXI_CPR_EXTINTMASK |
                          EXI_CPR_EXTINT);
            ...
            return type & ~(OS_INTR_MASK(OS_INTR_EXI_1_EXI) | OS_INTR_MASK(OS_INTR_EXI_1_TC) |
        ...
        case OS_INTR_EXI_2_TC:
            ...
            exi2Mask &= ~(EXI_CPR_EXIINTMASK | EXI_CPR_EXIINT | EXI_CPR_TCINTMASK | EXI_CPR_TCINT);
            ...
            return type & ~(OS_INTR_MASK(OS_INTR_EXI_2_EXI) | OS_INTR_MASK(OS_INTR_EXI_2_TC));
        /**
         * PI interrupts
         */
        case OS_INTR_PI_CP:
        ...
        case OS_INTR_PI_ACR:
            ...
            return type &
                   ~(OS_INTR_MASK(OS_INTR_PI_CP) | OS_INTR_MASK(OS_INTR_PI_PE_TOKEN) |
                     OS_INTR_MASK(OS_INTR_PI_PE_FINISH) | OS_INTR_MASK(OS_INTR_PI_SI) | OS_INTR_MASK(OS_INTR_PI_DI) |
                     OS_INTR_MASK(OS_INTR_PI_RSW) | OS_INTR_MASK(OS_INTR_PI_ERROR) | OS_INTR_MASK(OS_INTR_PI_VI) |
                     OS_INTR_MASK(OS_INTR_PI_DEBUG) | OS_INTR_MASK(OS_INTR_PI_HSP) | OS_INTR_MASK(OS_INTR_PI_ACR));
        default:
            return type;
    }
}

static inline u32 __OSMaskInterrupts_Inline(u32 userMask) {
...
static ASM void ExternalInterruptHandler(register u8 type, register OSContext* ctx) {
#ifdef __MWERKS__ // clang-format off
    nofralloc
